...
#include "revng/ABI/Specializations/AArch64.h"
#include "revng/ABI/Specializations/ARM.h"
#include "revng/ABI/Specializations/Microsoft_x86_64.h"
#include "revng/ABI/Specializations/Microsoft_x86_64_clrcall.h"
#include "revng/ABI/Specializations/Microsoft_x86_64_vectorcall.h"
#include "revng/ABI/Specializations/Microsoft_x86_cdecl.h"
#include "revng/ABI/Specializations/Microsoft_x86_clrcall.h"
#include "revng/ABI/Specializations/Microsoft_x86_fastcall.h"
#include "revng/ABI/Specializations/Microsoft_x86_stdcall.h"
#include "revng/ABI/Specializations/Microsoft_x86_thiscall.h"
#include "revng/ABI/Specializations/Microsoft_x86_vectorcall.h"
#include "revng/ABI/Specializations/Pascal_x86.h"
#include "revng/ABI/Specializations/SystemV_MIPS_o32.h"
#include "revng/ABI/Specializations/SystemV_x86.h"
#include "revng/ABI/Specializations/SystemV_x86_64.h"
#include "revng/ABI/Specializations/SystemV_x86_regparm_1.h"
#include "revng/ABI/Specializations/SystemV_x86_regparm_2.h"
#include "revng/ABI/Specializations/SystemV_x86_regparm_3.h"
#include "revng/ABI/Specializations/SystemZ_s390x.h"
#include "revng/Support/Concepts.h"

/// A trait struct used for describing the specifics of the calling convention
/// for an ABI to be used for CABIFunctionType representation within
/// the revng model
///
/// To register a new ABI, add a specialization of this trait.
///
...
concept IsCallingConventionTrait = requires(TraitType<ABI> Trait) {

  /// Indicates the ABI this `CallingConventionTrait` specialization describes.
...
consteval bool verifyCallingConventionTraits() {
  if constexpr (StartFrom == model::ABI::Count) {
    return true;
  } else {
    constexpr model::ABI::Values CurrentABI = model::ABI::Values(StartFrom);
    constexpr bool IsValid = IsCallingConventionTrait<Trait, CurrentABI>;
    static_assert(IsValid); // Improves error messages.

    constexpr bool R = verifyCallingConventionTraits<Trait, StartFrom + 1>();
    return IsValid && R;
  }
}
static_assert(verifyCallingConventionTraits<CallingConventionTrait, 1>());

...
using ConstModel = const TupleTree<model::Binary>;

template<class FO>
FEAnalyzer<FO>::FunctionEntrypointAnalyzer(ConstModel &Model,
                                           llvm::Module &M,
                                           GeneratedCodeBasicInfo *GCBI,
                                           FO &Oracle,
                                           ArrayRef<GlobalVariable *> ABICSVs) :
...
static void finalizeModel(GeneratedCodeBasicInfo &GCBI,

...
public:
  ...
  /// and/or dynamic symbol tables, keyed by raw address.
  std::map<uint64_t, LDDTree::Symbol> SymbolsByAddress;
...
private:
  ...
  void recordSymbol(const llvm::object::Elf_Sym_Impl<T> &Symbol);
